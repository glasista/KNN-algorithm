...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "KNN algorithm", 0));
        actionOtw_rz_Plik->setText(QApplication::translate("MainWindow", "Otw\303\263rz Plik", 0));
        actionInformacje->setText(QApplication::translate("MainWindow", "O programie", 0));
        actionZapisz_wykres->setText(QApplication::translate("MainWindow", "Zapisz wykres", 0));
        actionZamknij->setText(QApplication::translate("MainWindow", "Zamknij", 0));
        update->setText(QApplication::translate("MainWindow", "Aktualizuj", 0));
        Calculate->setText(QApplication::translate("MainWindow", "Oblicz", 0));
        groupBox->setTitle(QApplication::translate("MainWindow", "Miara odleg\305\202o\305\233ci", 0));
        cityblock->setText(QApplication::translate("MainWindow", "Odl. city-block", 0));
        canbeer->setText(QApplication::translate("MainWindow", "Odl. Canbeera", 0));
        euklides->setText(QApplication::translate("MainWindow", "Odl. Euklidesowa", 0));
        AddPoint->setText(QApplication::translate("MainWindow", "Dodaj ", 0));
        label->setText(QApplication::translate("MainWindow", "Parametr k", 0));
        label_2->setText(QApplication::translate("MainWindow", "Warto\305\233\304\207 X", 0));
        label_3->setText(QApplication::translate("MainWindow", "Warto\305\233\304\207 Y", 0));
        label_4->setText(QApplication::translate("MainWindow", "Kategoria", 0));
        isPrediction->setText(QApplication::translate("MainWindow", "Przewidywanie kategorii punktu", 0));
